...
class DemoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DemoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'demo'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DemoRequest copyWith(void Function(DemoRequest) updates) => super.copyWith((message) => updates(message as DemoRequest)) as DemoRequest;
