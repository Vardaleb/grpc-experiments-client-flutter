...
class DemoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DemoResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'demo'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DemoResponse copyWith(void Function(DemoResponse) updates) => super.copyWith((message) => updates(message as DemoResponse)) as DemoResponse;
